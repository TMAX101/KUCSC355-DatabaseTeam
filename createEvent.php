			...
			<table align="center">				
				<tbody>
					<tr>
						...
						<td align="left"><input type="text" name="Ename" id="Ename"required/></td>
					</tr>
					<tr>
						<td align="right">*Speaker:</td>
						<td align="left"><input type="text" name="speaker" id="speaker"required/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="left"><input type="text" name="date" id="date"required/></td>
					</tr>
					<tr>
						<td align="right">*Fee:</td>
						<td align="left"><input type="text" name="fee" id="fee"required/></td>
					</tr>
					<tr>
						<td align="right">*Description:</td>
						<td align="left"><textarea rows="6" cols="50" name="description" id="description"required/></textarea></td>
					</tr>
					<tr>
